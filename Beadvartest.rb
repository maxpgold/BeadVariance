...
#now need to make an array of l1.split(":").last, put array in high to low order, 
#and then choose first

# File.open("vcf_freq_lines_1").readlines.each do |line|
#    puts line
# end


#2nd one is commented out for now
...
# vcf_freq_lines_2 = tabix_io_2.readlines
# filtered_vcf_file_handle_2 = 'tmp.filtered.vcf'
# tmp_file_2 = File.open(filtered_vcf_file_handle_2, 'w')
# vcf_freq_lines_2.each{|r|tmp_file_2.write(r)}
# puts vcf_freq_lines_2
